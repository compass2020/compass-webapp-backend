...
@SpringBootTest(classes = CompassApp.class,
                properties = {
                        ...
                        "compass.android.updateRequired=true"})
public class UserJWTControllerAndroidUpdateRequiredIT {
    ...
    @Test
    @Transactional
    public void testAuthorizeAndroid() throws Exception {
    ...
    @Test
    @Transactional
    public void testAuthorizeAndroidFaild() throws Exception {
