...
import at.univie.compass.service.MailService;
...
import at.univie.compass.web.rest.errors.EmailAlreadyUsedException;
import at.univie.compass.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody UserDTO userDTO) throws URISyntaxException {
        log.trace("REST request to save User : {}", userDTO);
    ...
    public ResponseEntity<UserDTO> updateUser(@Valid @RequestBody UserDTO userDTO) {
        log.trace("REST request to update User : {}", userDTO);
    ...
    public ResponseEntity<UserDTO> getUser(@PathVariable String login) {
        log.trace("REST request to get User : {}", login);
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable String login) {
        log.trace("REST request to delete User: {}", login);
